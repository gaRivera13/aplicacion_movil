...
import { BarcodeFormat, BarcodeScanner, ScanResult } from '@capacitor-mlkit/barcode-scanning';  // HAY QUE HACER INSTALACION DE UN CAPACITOR
...
export class ScannerService {
   ...
   *  Para instalar el escaner instalar en la terminal:
   * npm install @capacitor-mlkit/barcode-scanning
   * npx cap syncnpx cap sync
   */
